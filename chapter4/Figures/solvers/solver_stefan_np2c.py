...
class SolverStefan6p2c:
    ...
    def __init__(self,Thermo, Diff, Init, nphases):
        self.Thermo=Thermo
        self.Diff=Diff
        self.Init=Init
        
        self.phase_count=nphases
    ...
    def diff_A(self,n):
        if n%2==0:
            return self.Diff.Dl1
        else:
            return self.Diff.Ds1

    def diff_B(self,n):
        if n%2==0:
            return self.Diff.Dl2
        else:
            return self.Diff.Ds2
    ...
    def u212A(self,x12,x23):
        ...
        return (D/np.pi)**0.5*np.exp(-l212**2)/du212A
    ...
    def u212B(self,x12,x23):
        ...
        return (D/np.pi)**0.5*np.exp(-l212**2)/du212B
    ...
    def u223A(self,x12,x23):
        ...
        return -(D/np.pi)**0.5*np.exp(-l223**2)/du223A
    ...
    def u223B(self,x12,x23):
        ...
        return -(D/np.pi)**0.5*np.exp(-l223**2)/du223B
    ...
    def u323A(self,x23,x34):
        ...
        return -(D/np.pi)**0.5*np.exp(-l323**2)/du323A
    ...
    def u323B(self,x23,x34):
        ...
        return -(D/np.pi)**0.5*np.exp(-l323**2)/du323B
    ...
    def u334A(self,x23,x34):
        ...
        return -(D/np.pi)**0.5*np.exp(-l334**2)/du334A
    ...
    def u334B(self,x23,x34):
        ...
        return -(D/np.pi)**0.5*np.exp(-l334**2)/du334B
    ...
    def u434A(self,x34,x45):
        ...
        return -(D/np.pi)**0.5*np.exp(-l434**2)/du434A
    ...
    def u434B(self,x34,x45):
        ...
        return -(D/np.pi)**0.5*np.exp(-l434**2)/du434B
    ...
    def u445A(self,x34,x45):
        ...
        return (D/np.pi)**0.5*np.exp(-l445**2)/du445A
    ...
    def u445B(self,x34,x45):
        ...
        return (D/np.pi)**0.5*np.exp(-l445**2)/du445B
    ...
    def u545A(self,x45,x56):
        ...
        l545=x45/2/(D)**0.5
        l556=x56/2/(D)**0.5
        du545A=(special.erfc(-l556)-special.erfc(-l545))
        return (D/np.pi)**0.5*np.exp(-l545**2)/du545A
        
    def u545B(self,x45,x56):
        D=self.D5_2
        l545=x45/2/(D)**0.5
        l556=x56/2/(D)**0.5
        du545B=(special.erfc(-l556)-special.erfc(-l545))
        return (D/np.pi)**0.5*np.exp(-l545**2)/du545B
    ...
    def u556A(self,x45,x56):
        ...
        l545=x45/2/(D)**0.5
        l556=x56/2/(D)**0.5
        du=(special.erfc(-l556)-special.erfc(-l545))
        return (D/np.pi)**0.5*np.exp(-l556**2)/du
    ...
    def u656A(self,x56):
        D=self.D6_1
        l656=x56/2/(D)**0.5
        return (D/np.pi)**0.5*np.exp(-l656**2)/(special.erfc(l656))
    ...
    def f(self,vect):
        ...
        res.append()
        # middle interfs
        for i in range(1,self.phase_count-2):
            xi=
