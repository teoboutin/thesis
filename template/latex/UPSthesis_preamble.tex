...
\vspace*{1pc}%
\vbox{\hspace{3em}\Large \textit{Som\hspace{-0.7pt}maire du chapitre}}%
\vspace*{3pt}%
...
{\filright\textsc{\chaptertitlename\ \thechapter}}% label
{10pt}% sep between label and title
{\filright\Huge\upshape\bfseries}%
[\startcontents]% after code
% [\startcontents \normalsize\chapterPartialToc]% after code

\titlespacing*{\chapter}{5pt}{-20pt}{0pt}
