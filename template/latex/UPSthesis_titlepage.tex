...
\newcommand{\makeThesisTitlePage}{
    \begin{titlepage}
        ...
        \end{tabular} 
        % \small \'Ecole doctorale n°579: Sciences Mécaniques et \'Energétiques, Matériaux et Géosciences (SMEMaG)\\
        % \small Spécialité de doctorat: Sciences des Matériaux\\
        % \small Graduate School: Université Paris-Saclay GS Sciences de l’ingénierie et des systèmes\\
        % \small Référent: CentraleSupélec \\
        \vspace{6mm}
